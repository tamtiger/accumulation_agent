# accumulation_agent — Agent Instructions

> Generated by harness-os v1.5.1 on 2026-06-10. Stack: python. Package manager: npm.

> **Note:** Original AGENTS.md preserved as `AGENTS_OLD.md`. Refer to it for project-specific instructions that may need to be merged.
...
This is a **python** project managed by harness-os. The harness ensures agents verify before claiming done, stay within scope, maintain context across sessions, and learn from patterns.

- **Repo:** accumulation_agent
- **Stack:** python
- **Package Manager:** npm
- **Harness version:** 1.5.1
